...
public class ToShape extends Copy {

	private static final String NAME = "To shape";
	
	public ToShape(Move move) {
	...
	protected void execute(String srcLayerId, String dstLayerId, int xMin,
		...
		GWTFacade.get().toShape(srcLayerId, dstLayerId, xMin, yMin, xMax, yMax, 
